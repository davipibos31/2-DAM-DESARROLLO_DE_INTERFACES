...
{
    public partial class Articulo_4 : ContentPage
    {
        ...
        public Articulo_4()
        {
            ...
            ldesc.Text = "Descripción del articulo: " + Articulos.listar[3];
            ldesc.FontSize = 18;
            ldesc.Margin = 10;


            Label ldescart = new Label();
            ldescart.Text = "Esto es la descripción del articulo " + Articulos.listar[3];
        ...
        private void Añadir_Clicked(object sender, EventArgs e)
        {
            ...
            Label l2 = new Label();
            l2.Text = "Total: " + (ItemsPage.resultadoFinal = res += c) + "€";
            l2.Margin = 30;
