...
{
    public partial class Articulo_3 : ContentPage
    {
        ...
        public Articulo_3()
        {
            ...
            ldesc.Text = "Descripción del articulo: " + Articulos.listar[2];
            ldesc.FontSize = 18;
            ldesc.Margin = 10;


            Label ldescart = new Label();
            ldescart.Text = "Esto es la descripción del articulo " + Articulos.listar[2];
        ...
        public static int res = ItemsPage.resultadoFinal;
        private void Añadir_Clicked(object sender, EventArgs e)
        {
            Label l1 = new Label();
            l1.Text = Articulos.listar[2];
            l1.FontSize = 22;
            ...
            Label l2 = new Label();
            l2.Text = "Total: " + (ItemsPage.resultadoFinal = res += b) + "€";
            l2.Margin = 30;
