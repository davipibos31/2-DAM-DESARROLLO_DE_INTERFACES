...
{
    public partial class Articulo2 : ContentPage
    {
        ...
        public Articulo2()
        {
            ...
            ldesc.Text = "Descripción del articulo: " + Articulos.listar[1];
            ldesc.FontSize = 18;
            ldesc.Margin = 10;


            Label ldescart = new Label();
            ldescart.Text = "Esto es la descripción del articulo " + Articulos.listar[1];
        ...
        private void Añadir_Clicked(object sender, EventArgs e)
        {
            ...
            Label l2 = new Label();
            l2.Text = "Total: " + (ItemsPage.resultadoFinal = res += d) + "€";
            l2.Margin = 30;
